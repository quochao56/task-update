                        ...
                        <div class="wrap-slick3 flex-sb flex-w">
                            ...
                            <div class="slick3 gallery-lb">
                                <div class="item-slick3" data-thumb="{{$product->thumb}}">
                                    <div class="wrap-pic-w pos-relative" style="width: 400px;">
                                        <img src="{{$product->thumb}}" height="400" alt="IMG-PRODUCT">
                        ...
                        <div class="flex-w flex-r-m p-b-10">
                            <div class="size-204 flex-w flex-m respon6-next">
                                <form action="/add-cart" method="post">
                                    ...
                                    <button
                                        class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 js-name-detail">
                                        Add to cart
                                    </button>
                                ...
                                <div class="p-b-30 m-lr-15-sm">
                                    ...
                                    <div class="flex-w flex-t p-b-68">
                                        <div class="wrap-pic-s size-109 bor0 of-hidden m-r-18 m-t-6">
                                            <img src="/qh/dashboard/template/images/avatar-01.jpg" alt="AVATAR">
                                        </div>
                                ...
                                <div class="block2-txt-child2 flex-r p-t-3">
                                    <a href="#" class="btn-addwish-b2 dis-block pos-relative js-addwish-b2">
                                        <img class="icon-heart1 dis-block trans-04"
                                             src="/qh/dashboard/template/images/icons/icon-heart-01.png" alt="ICON">
                                        <img class="icon-heart2 dis-block trans-04 ab-t-l"
                                             src="/qh/dashboard/template/images/icons/icon-heart-02.png" alt="ICON">
                                    </a>
                                </div>
                            </div>
                        </div>
